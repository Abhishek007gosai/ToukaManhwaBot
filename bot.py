...
class Vars:
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "7689010904:AAFJ48GX1zDr7mxPQxReDbgSSvp-e0Hcw_Y")
  ...
  SHORTENER = True
  SHORTENER_API = '64d631b036df348caab852591a09288cbf5b6809?url={shortxlinks.com}' # put {} for url, ex: shornter.api?url={}
  DURATION = 20 # hrs
