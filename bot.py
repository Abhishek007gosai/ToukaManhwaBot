...
class Vars:
  ...
  SHORTENER = True
  SHORTENER_API = 'https://shortxlinks.com/api?url=64d631b036df348caab852591a09288cbf5b6809&url={}' # put {} for url, ex: shornter.api?url={}
  DURATION = 20 # hrs
  ...
  FORCE_SUB_CHANNEL = os.environ.get("FORCE_SUB_CHANNEL", "» ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ «: -1001987570479, » ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ «: -1001457313028")#𝕵𝖔𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Guimi_Zhi_Zhu_Anime, 𝕸𝖆𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Wizard_Bots")
