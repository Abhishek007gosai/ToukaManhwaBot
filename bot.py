...
class Vars:
  ...
  BOT_TOKEN = "7689010904:AAFJ48GX1zDr7mxPQxReDbgSSvp-e0Hcw_Y"
  ...
  SHORTENER = True
  SHORTENER_API = "64d631b036df348caab852591a09288cbf5b6809?shortxlinks.com={}" # put {} for url, ex: shornter.api?url={}
  DURATION = 20 # hrs
  ...
  FORCE_SUB_CHANNEL = os.environ.get("FORCE_SUB_CHANNEL", "Jᴏɪɴ ᴄʜᴀɴɴᴇʟ: -1001987570479, Jᴏɪɴ ᴄʜᴀɴɴᴇʟ: Omniscient_Readers_Viewpoint_MN")#𝕵𝖔𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Guimi_Zhi_Zhu_Anime, 𝕸𝖆𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Wizard_Bots")
